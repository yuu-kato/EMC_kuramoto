...
// execute: nohup apptainer exec --env OMP_NUM_THREADS=20 filename.sif > log.txt ./a.out &
//
// for local
...
int main() {
    ...
    ofstream Data_out1("./output_files/sigma_list.txt");
    ofstream Data_out2("./output_files/result_rep.txt");
