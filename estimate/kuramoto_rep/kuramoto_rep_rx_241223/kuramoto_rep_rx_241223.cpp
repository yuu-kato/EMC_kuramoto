...
// Repeated estimation with varioud noise strength
// Different fixed seeds are used for data generation and estimation
//
// for apptainer in HPCs:
...
int main() {
    ...
    // output files
    mkdir("./output_files", 0755); // 0755 means 'allowing the owner to write, read, execute, while allowing others only to read and execute'
    ofstream Data_out0("./output_files/true_parameters.csv");
    ofstream Data_out1("./output_files/oscillator_num_list.txt");
    ofstream Data_out2("./output_files/result_rep_kuramoto.txt");
    ofstream Data_out3("./output_files/exchange_rate.csv");
    ofstream Data_out4("./output_files/acceptance_rate.csv");
